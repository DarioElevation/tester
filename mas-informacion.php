...
<?php
		...
		include(DIR_CLASES.'clase_contacto_informacion.php');
?>
<div id="contenido_registro">
	<p id="titulo_registro" class="setentaycinco izquierda">
		...
		if(!isset($_GET['rel'])) 
			{ 
    			echo 'Deseo conocer más acerca<br/>de Orixgen';
        	} 
		elseif($_GET['rel']=='inscripcion')
			{
				echo 'Quiero adquirir producto o inscribirme en Orixgen';
			}
		?>
    </p>
